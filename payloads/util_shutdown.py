...
"""
RaspyJack *payload* – **Utility: Shutdown Device**
===================================================
A simple utility payload that shuts down the RaspyJack device.
"""
    ...
    try:
        ...
        while time.time() - start_wait < 5.0:
            ...
            if GPIO.input(PINS["OK"]) == 0:
                ...
                time.sleep(5) # Give time for shutdown command to execute
                break
            time.sleep(0.1)
