...
"""
RaspyJack *payload* – **HID Attack: Run APT Update (Linux)**
=============================================================
A HID attack that opens a terminal on a Debian-based Linux machine
and runs `sudo apt update && sudo apt upgrade -y`.

**NOTE:** This requires the user to have sudo privileges and may require
them to enter their password. It can also be very disruptive.
"""
...
def run_attack():
    ...
    show_message(["HID Attack:", "Linux APT Update"])
