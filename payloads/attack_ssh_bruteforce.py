...
# --- CONFIGURATION ---
TARGET_IP = "192.168.1.20" # Default IP, will be configurable
...
found_creds = ""
current_ip_input = "192.168.1.20" # Initial value for IP input
    ...
    while running:
        ...
        if btn == "OK": # Confirm IP
            ...
            if len(parts) == 4 and all(p.isdigit() and 0 <= int(p) <= 255 for p in parts):
                ...
                time.sleep(2)
                current_ip_input = "192.168.1.20" # Reset to default
